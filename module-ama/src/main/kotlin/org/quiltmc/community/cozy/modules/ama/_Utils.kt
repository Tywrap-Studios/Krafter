...
public suspend inline fun ComponentContainer.questionComponents(
	...
	ephemeralButton {
		label = Translations.Buttons.Label.accept
		...
		action {
			...
			answerQueueMessage = answerQueueChannel?.createMessage {
				...
				components {
					ephemeralButton {
						label = Translations.Buttons.Label.claim
					...
					ephemeralButton {
						label = Translations.Buttons.Label.skip
	...
	ephemeralButton {
		label = Translations.Buttons.Label.deny
	...
	if (flaggedQuestionChannel != null) {
		ephemeralButton {
			label = Translations.Buttons.Label.flag
			style = ButtonStyle.Secondary
...
public suspend inline fun ComponentContainer.answeringButtons(
	...
	ephemeralButton {
		label = Translations.Buttons.Label.stage
		style = ButtonStyle.Success
	...
	ephemeralButton {
		label = Translations.Buttons.Label.text
		style = ButtonStyle.Success
		check {
			if (event.interaction.user != claimer) {
